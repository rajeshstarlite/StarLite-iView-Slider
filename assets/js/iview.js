		...
		setCaption: function () {
			...
			captions.each(function (i) {
				var caption = $(this),
					...
					cap_position = caption.data('cap_position');
					switch (cap_position) {
						case "topleft":
						x = 0 ; y = 0; //top-left case
						break;
						case "topright":
						x = iv.defs.width - oW;  y = 0; //top-right case
						break;
						case "bottomleft":
						x = 0 ; y = iv.defs.height - oH; //bottom-left case
						break;
						case "bottomright":
						x = iv.defs.width - oW;  y = iv.defs.height - oH; //bottom-right case
						break;
					}
